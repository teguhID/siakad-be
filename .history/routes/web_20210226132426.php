...
$router->group(['middleware' => 'auth'], function () use ($router) {
    ...
    // master guru
    $router->get('master/murid', 'Master\Guru@get');
    $router->get('master/murid/{id}', 'Master\Guru@detail');
    $router->post('master/murid/create', 'Master\Guru@create');
    $router->post('master/murid/update/{id}', 'Master\Guru@update');
    $router->get('master/murid/delete/{id}', 'Master\Guru@delete');
