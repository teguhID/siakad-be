...
class KelasMataPelajaran extends Controller
{
    public function get()
    {
        return response()->json([
            'status'  => 200,
            'message' => 'Success',
            'data'    => Cn_Kelas_Mata_Pelajaran::with('mata_pelajaran')->with('kelas')->get(),
        ], 200);
    }
    ...
    public function detail($id)
    {
        return response()->json([
            'status'  => 200,
            'message' => 'Success',
            'data'    => Cn_Kelas_Mata_Pelajaran::where('id_conf_kelas_mata_pelajarans', $id)->with('mata_pelajaran')->with('kelas')->first(),
        ], 200);
    }
